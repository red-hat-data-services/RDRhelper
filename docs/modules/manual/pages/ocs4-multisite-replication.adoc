...
[source,role="execute"]
----
curl -s https://raw.githubusercontent.com/red-hat-storage/RDRhelper/master/docs/modules/manual/attachments/replicapool.yaml | oc apply -f -
----
.Example output:
----
...
[source,role="execute"]
----
curl -s https://raw.githubusercontent.com/red-hat-storage/RDRhelper/master/docs/modules/manual/attachments/rbd-mirror.yaml | sed -e "s/SECRET/${SECRET}/g" | oc apply -f -
----
.Example output:
----
...
[source,role="execute"]
----
curl -s https://raw.githubusercontent.com/red-hat-storage/RDRhelper/master/docs/modules/manual/attachments/ocs-storagecluster-ceph-mirror.yaml | oc apply -f -
----
.Example output:
----
...
[source,role="execute"]
----
curl -s https://raw.githubusercontent.com/red-hat-storage/RDRhelper/master/docs/modules/manual/attachments/backup.yaml | oc apply -f -
----
.Example output:
----
...
[source,role="execute"]
----
curl -s https://raw.githubusercontent.com/red-hat-storage/RDRhelper/master/docs/modules/manual/attachments/restore.yaml | oc apply -f -
----
.Example output:
----
